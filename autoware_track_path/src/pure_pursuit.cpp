...
PurePursuit::PurePursuit() {
    ...
    pn.param("lfw", lfw, 0.0);   // distance between front the center of car
...
void PurePursuit::odomCB(const nav_msgs::Odometry::ConstPtr& odomMsg) { this->odom = *odomMsg; }

void PurePursuit::pathCB(const nav_msgs::Path::ConstPtr& pathMsg) { this->map_path = *pathMsg; }
...
double PurePursuit::getSteering(double eta) { return atan2((this->L * sin(eta)), (this->Lfw / 2 + this->lfw * cos(eta))); }
